...
def page_project_hypothesis_body():
    ...
    st.success(
        ...
        "because quality has a higher effect and YearBuilt has "
        ...
        "* We think that one of the reasons YearBuilt has a big effect because"
        " a new house is often in better condition, "
        "that can also be a reason why a house from 1940 "
        "has about the same SalePrice as one from 1960. "
        "The YearRemodAdd also has a decently high correlation, but "
